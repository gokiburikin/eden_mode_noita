...
local blacklist = {
    projectile_actions = { TELEPORT_PROJECTILE=false, BLACK_HOLE=false },
    cost_actions = { },
    modifier_actions = { },
    utility_actions = { },
};
...
while action_count > 0 do
    local random_action = random_from_array( gun[EntityComponentGetValue( entity_id, "VariableStorageComponent", "value_string", "eden_actions_pool" )] );
